...
from dino_runner.utils.constants import (RUNNING,JUMPING,DUCKING,DEFAULT_TYPE,DUCKING_SHIELD,RUNNING_SHIELD,JUMPING_SHIELD,SHIELD_TYPE,FONT_BOLD, SCREEN_WIDTH,SCREEN_HEIGHT)
